...
function start(barOptions) {
  ...
  tl.from(".t2", (0, _commonJsBasketballJs.stag)(vh), "+=.2");
  tl.to(".t2", { duration: 0.3, opacity: 0 }, "+=" + _commonJsBasketballJs.READ.t2);
  ...
  tl.from(".t4", { duration: 0.3, opacity: 0 });
  tl.from([".cta", ".legalBtn"], { duration: 0.3, opacity: 0 }, "+=.2");
