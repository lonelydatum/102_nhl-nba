...
var colors = ["e0f0e0", "d3ead3", "c5e3c5", "b8ddb8", "aad7ac", "9cd2a0", "8dcd94", "7fc889", "70c27c", "5fbd71", "4bb964", "35b55a", "35b55a", "35b55a"];
...
function start(barOptions) {
  ...
  var ignoreText2 = barOptions.ignoreText2 || false;
...
exports.READ = READ;
exports.animate_bars_horizontal = animate_bars_horizontal;
exports.stag = stag;
...
var _commonJsBasketballJs = require("../../_common/js/basketball.js");

function start(barOptions) {
  var vh = arguments.length <= 1 || arguments[1] === undefined ? { x: -_commonJsBasketballJs.size.w } : arguments[1];

  var ignoreText2 = barOptions.ignoreText2 || false;
  console.log(ignoreText2);

  var tl = (0, _commonJsBasketballJs.init)();

  var fun = barOptions.HEIGHT > barOptions.WIDTH ? _commonJsBasketballJs.animate_bars_horizontal : animate_bars_vertical;
  fun(barOptions);
  TweenLite.to(".hero img", _extends({ duration: 3 }, barOptions.scale));

  tl.from(".t1", (0, _commonJsBasketballJs.stag)(vh), "+=.4");
  tl.to(".t1", { duration: 0.3, opacity: 0 }, "+=" + _commonJsBasketballJs.READ.t1);
  var listter = [".frame1"];
  if (ignoreText2) {
    tl.to(listter, { duration: 0.3, opacity: 0 });
  } else {
    tl.from(".t2", (0, _commonJsBasketballJs.stag)(vh));
    tl.to(listter, { duration: 0.3, opacity: 0 }, "+=" + _commonJsBasketballJs.READ.t2);
  }
...
start(barOptions, { y: _commonJsBasketballJs.size.h });

module.exports = {};

},{"../../_common/js/basketball.js":1}]},{},[3])
